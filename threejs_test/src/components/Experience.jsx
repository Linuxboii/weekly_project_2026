        ...
        <group>
            ...
            {planetStates.map((p, i) => (
                <Planet
                    ...
                    // Logic: Is selected manually OR is active automatically (and not actively checking another)
                    isSelected={selectedPlanetName === p.def.name || (selectedPlanetName === null && activePlanetName === p.def.name)}
                    onClick={(def) => {
...
function SystemController({ planetStates, planetRefs, onActivePlanetChange }) {
