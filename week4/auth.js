 ...
 * ============================================
 * 
 * FOR USE ON: https://week4.avlokai.com (and other protected projects)
 * 
 * This script handles:
...
function getLoginUrl() {
    ...
    // 2. Custom domain (week4.avlokai.com) → go to login.avlokai.com
    if (hostname === CUSTOM_DOMAINS.week4) {
        return `https://${CUSTOM_DOMAINS.login}/`;
    }

    // 3. Vercel deployment → redirect to production custom domain
    if (hostname.endsWith('.vercel.app')) {
        console.log('[week4] Vercel deployment detected, using production login URL');
        return `https://${CUSTOM_DOMAINS.login}/`;
    }
...
console.log('[week4] Login URL:', AUTH_GUARD_CONFIG.LOGIN_PAGE_URL);
...
function showMainApp() {
    ...
    document.title = 'Avlok AI - Week 4';
}
